...
The forward difference is of first order, meaning that the error is proportional to $\Delta t$. The centred difference, on the other hand, is of second order, with an error proportional to $\Delta t^2$ for the time derivative and $\Delta x^2$ for the spacial derivative.     
